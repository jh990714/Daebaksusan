...
export const AddressFinderButton: React.FC<AddressFinderButtonProps> = ({ onCompletePostcode, className }) => {
  ...
  const buttonClassName = className ? className : "w-32 h-10 ml-4 bg-blue-500 text-white font-bold rounded-md cursor-pointer flex justify-center items-center transition duration-300 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500";
