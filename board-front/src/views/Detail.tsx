    ...
    <div className="bg-white text-gray-700">
      <main className="container mx-auto my-4 p-4">
        <div className="flex flex-wrap md:flex-nowrap items-stretch relative">
          {/* 이미지 영역 */}
          <div className="w-2/3 lg:w-1/2 mx-auto px-2 md:px-4 mb-3">
            <img
          ...
          <div className="w-full lg:w-1/2 border-t-2 border-b-2 border-blue-700 px-2 md:px-4">
              ...
              <div className="text-start border-b-2 border-gray-200 px-4 py-2">
                <div className="grid grid-cols-5 gap-1 items-center">
                  ...
                  <div className="col-span-4 text-base sm:text-lg">
                    {product!.salePrice ? (
                      <>
                        <span className="line-through text-gray-500 text-sm mr-2">{product!.regularPrice.toLocaleString()}원</span>
                        <span className="font-bold text-xl">{(product!.regularPrice - product!.salePrice).toLocaleString()}원</span>
                      </>
                    ) : (
                      <span className="font-bold text-xl">{product!.regularPrice.toLocaleString()}원</span>
                    )}
                  </div>
            ...
            <div className="flex justify-between border-2 border-blue-700 rounded text-base sm:text-2xl font-bold">
              <div className="p-3 sm:p-4 text-white bg-blue-700">최종 금액</div>
              <div className="p-3 sm:p-4 text-blue-700 text-end">
