            ...
            <div className="bg-white min-h-screen text-left">
                <div className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="bg-gray-100 rounded-lg shadow-md p-6 mb-8">
                        ...
                        <ul className="pl-4">
                            <li><span className="font-semibold inline-block w-32">상품명:</span> {name}</li>
                            <li><span className="font-semibold inline-block w-32">최종결제 금액:</span> {amount.toLocaleString()}원</li>
