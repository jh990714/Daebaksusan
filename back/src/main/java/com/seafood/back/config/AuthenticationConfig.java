    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests((authorizeRequests) -> {
                authorizeRequests.requestMatchers("/check", "/info/**", "/cart/**", "/points/**", "/members/withdraw", "/members/authenticate", "/qna/ask").authenticated();
            ...
            // ROLE_은 붙이면 안 된다. hasAnyRole()을 사용할 때 자동으로 ROLE_이 붙기 때문이다.
                ...
                authorizeRequests.requestMatchers("/members/**", "/product/**", "/refreshToken", "/categories", "/oauth2/**", "/payment/**", "/reviews/**", "/guest/**", "/qna/**", "/home/**").permitAll();
            })
